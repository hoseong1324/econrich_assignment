...
public class PatchJobsService {
    ...
    @Transactional
    public void execute(String jobId, JobHistoryDto.UpdateJobs form) {
    ...
    @Transactional
    public void executeForPercentSalary(String jobId, JobHistoryDto.UpdateSalaryByPercent form) {
        Jobs jobs = jobsRepository.findById(jobId)
                .orElseThrow(() -> new CustomException(ExceptionCode.JOBS_NOT_FOUND));
